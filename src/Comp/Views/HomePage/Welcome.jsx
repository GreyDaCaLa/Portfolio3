...
<nav className="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
    <a className="navbar-brand js-scroll-trigger" href="#page-top">
        ...
        {/* <span className="d-none d-lg-block"><img className="img-fluid img-profile rounded-circle mx-auto mb-2" src={sampleimage} alt="..." /></span> */}
    ...
    <div className="collapse navbar-collapse" id="navbarResponsive">
        <ul className="navbar-nav">
            ...
            <li className="nav-item"><a className="nav-link js-scroll-trigger" href="#certifi">Certifications</a></li>
...
analytical and problem-solving skills to create dynamic websites and webapps platforms fueling a competitive advantage.
            ...
            <div className="social-icons d-flex">
                <a className="social-icon" target="_blank" href="https://www.linkedin.com/in/gregdeleon555/"><i className="fab fa-linkedin-in"></i></a>
                <a className="social-icon" target="_blank" href="https://github.com/GreyDaCaLa"><i className="fab fa-github"></i></a>
    ...
    <section className="resume-section" id="experience">
        <div className="resume-section-content">
            ...
            <div className="d-flex flex-column flex-md-row justify-content-between mb-5">
                ...
                <div className="flex-shrink-0"><span className="text-primary">August 2018 - August 2021</span></div>
            </div>


            <div className="d-flex flex-column flex-md-row justify-content-between mb-5">
                <div className="flex-grow-1">
                    <h3 className="mb-0">SolidWorks Electrical Manager</h3>
                    <div className="subheading mb-3">HS Automation</div>
                      <ul className="">
                ...
                <div className="flex-shrink-0"><span className="text-primary">August 2020 - August 2021</span></div>
            </div>
            ...
            <div className="d-flex flex-column flex-md-row justify-content-between mb-5">
                ...
                <div className="flex-shrink-0"><span className="text-primary">February 2022 - March 2022</span></div>
            </div>
    ...
    <section className="resume-section" id="certifi">
        <div className="resume-section-content">
            ...
            <ul className="fa-ul mb-0">
                <li>
                    <span className="fa-li"><i className="fa-solid fa-circle-dot"></i></span>
              ...
              <div className="row g-0">
                ...
                <div className="col-md-8">
                  <div className="card-body">
                    ...
                    <p className="card-text">Just like the original the goal is to connect 4 chips in a row diagnoally vertically or horizontally but 2 added twists are a secound of the grid and 2 more players.</p>
                <div className="flex-shrink-0"><span className="text-primary">August 2018 - August 2021</span></div>
    ...
    <section className="resume-section" id="education">
        <div className="resume-section-content">
            ...
            <div className="d-flex flex-column flex-md-row justify-content-between mb-5">
                ...
                <div className="flex-shrink-0"><span className="text-primary">June 2013 - May 2018</span></div>
            </div>
